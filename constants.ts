...
export const PRODUCTS: Product[] = [
  ...
  // 1. CAMPEÃO DE VENDAS
  {
    ...
    price: 16,
    image: 'https://i.ibb.co/Nd5TcN3B/creative-masterpiece-85.jpg',
  ...
  // 2. MAIS PEDIDOS
  {
    ...
    price: 20,
    image: 'https://i.ibb.co/jPcs8ThH/creative-masterpiece-88.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.LAGER,
    volumeLiters: 1,
    isPopular: true,
  ...
  },
  {
    ...
    price: 20,
    image: 'https://i.ibb.co/N6JSjBgb/creative-masterpiece-89.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.LAGER,
    volumeLiters: 1,
    isPopular: true,
  ...
  },
  {
    ...
    price: 22,
    image: 'https://i.ibb.co/zTQ51YTh/creative-masterpiece-87.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.IPA,
    volumeLiters: 1,
    isPopular: true,
  ...
  // R$ 17,00
  {
    ...
    price: 18,
    image: 'https://i.ibb.co/ycB8PmF4/creative-masterpiece-86.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.LAGER,
    volumeLiters: 1,
    abv: 4.5,
  ...
  },
  {
    ...
    price: 22,
    image: 'https://i.ibb.co/JjjyzVPJ/creative-masterpiece-92.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.AMBER,
    volumeLiters: 1,
    abv: 5.3,
  ...
  },
  {
    ...
    price: 22,
    image: 'https://i.ibb.co/skD0p9b/creative-masterpiece-93.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.DUNKEL,
    volumeLiters: 1,
    abv: 4.9,
  ...
  },
  {
    ...
    price: 22,
    image: 'https://i.ibb.co/LXVr2jHJ/creative-masterpiece-96.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.APA,
    volumeLiters: 1,
    abv: 5.0,
  ...
  },
  {
    ...
    price: 22,
    image: 'https://i.ibb.co/zVrFFH8W/creative-masterpiece-94.jpg',
    category: ProductCategory.GROWLER,
  ...
  },
  {
    ...
    price: 22,
    image: 'https://i.ibb.co/FbWB5Kww/creative-masterpiece-98.jpg',
    category: ProductCategory.GROWLER,
  ...
  // R$ 26,00
  {
    ...
    price: 26,
    image: 'https://i.ibb.co/s9TcHRr7/creative-masterpiece-95.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.IPA,
    volumeLiters: 1,
    abv: 6.1,
  ...
  // R$ 30,00 (Sours)
  {
    ...
    price: 30,
    image: 'https://i.ibb.co/ym33GrCk/creative-masterpiece-91.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.SOUR,
    volumeLiters: 1,
    abv: 5.0,
  ...
  },
  {
    ...
    price: 30,
    image: 'https://i.ibb.co/mCFCKYCM/creative-masterpiece-90.jpg',
    category: ProductCategory.GROWLER,
    type: BeerType.SOUR,
    volumeLiters: 1,
    abv: 5.0,
