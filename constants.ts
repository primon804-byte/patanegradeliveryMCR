...
export const PRODUCTS: Product[] = [
  ...
  // 1. CAMPEÃO DE VENDAS
  {
    ...
    price: 16,
    image: '/images/products/growler-pilsen-cristal.webp',
  ...
  // 2. MAIS PEDIDOS
  {
    ...
    price: 20,
    image: '/images/products/growler-vinho-branco.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.LAGER,
    volumeLiters: 1,
    isPopular: true,
  ...
  },
  {
    ...
    price: 20,
    image: '/images/products/growler-vinho-tinto.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.LAGER,
    volumeLiters: 1,
    isPopular: true,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-session-ipa.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.IPA,
    volumeLiters: 1,
    isPopular: true,
  ...
  // R$ 17,00
  {
    ...
    price: 18,
    image: '/images/products/growler-premium-lager.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.LAGER,
    volumeLiters: 1,
    abv: 4.5,
  ...
  // R$ 22,00 (Vários Estilos)
  {
    ...
    price: 24,
    image: '/images/products/growler-malzbier.webp',
    category: ProductCategory.GROWLER,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-weiss.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.WEISS,
    volumeLiters: 1,
    abv: 5.0,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-amber-lager.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.AMBER,
    volumeLiters: 1,
    abv: 5.3,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-munich-dunkel.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.DUNKEL,
    volumeLiters: 1,
    abv: 4.9,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-apa.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.APA,
    volumeLiters: 1,
    abv: 5.0,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-red-ale.webp',
    category: ProductCategory.GROWLER,
  ...
  },
  {
    ...
    price: 22,
    image: '/images/products/growler-vienna-lager.webp',
    category: ProductCategory.GROWLER,
  ...
  // R$ 26,00
  {
    ...
    price: 26,
    image: '/images/products/growler-american-ipa.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.IPA,
    volumeLiters: 1,
    abv: 6.1,
  ...
  // R$ 30,00 (Sours)
  {
    ...
    price: 30,
    image: '/images/products/growler-sour-amarelas.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.SOUR,
    volumeLiters: 1,
    abv: 5.0,
  ...
  },
  {
    ...
    price: 30,
    image: '/images/products/growler-sour-vermelhas.webp',
    category: ProductCategory.GROWLER,
    type: BeerType.SOUR,
    volumeLiters: 1,
    abv: 5.0,
  ...
  // ============================================================================
  {
    ...
    description: 'A típica Pilsen dos brasileiros. Cerveja clara, leve, refrescante e de baixo amargor.',
    price: 387,
    image: '/images/products/barril-pilsen.webp',
  ...
  },
  {
    ...
    description: 'Cerveja dourada com notas maltadas, corpo médio, amargor moderado e espuma cremosa.',
    price: 420,
    image: '/images/products/barril-lager.webp',
    category: ProductCategory.KEG30,
    type: BeerType.LAGER,
    volumeLiters: 30,
  ...
  },
  {
    ...
    description: 'Fermentado de uvas Moscato, levemente adocicado, ideal para dias quentes.',
    price: 468,
    image: '/images/products/barril-vinho-branco.webp',
    category: ProductCategory.KEG30,
    type: BeerType.LAGER,
    volumeLiters: 30,
    isPopular: true,
  ...
  },
  {
    ...
    description: 'Fermentado de uvas Isabel e Bordeaux, com perfil frisante e creme marcante.',
    price: 468,
    image: '/images/products/barril-vinho-tinto.webp',
    category: ProductCategory.KEG30,
    type: BeerType.LAGER,
    volumeLiters: 30,
    abv: 5.0,
  ...
  },
  {
    ...
    description: 'Cerveja leve, dourada, extremamente refrescante, com amargor moderado e aroma cítrico intenso.',
    price: 507,
    image: '/images/products/barril-session-ipa.webp',
    category: ProductCategory.KEG30,
    type: BeerType.IPA,
    volumeLiters: 30,
    abv: 5.0,
